                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-html" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" name="name" value="Uniorder" class="form-control" />
                            <?php if ($error_name) { ?>
...
$('form > div:first').addClass('hide');
$('form > div:eq(1) > div > div > div:eq(1)').addClass('hide');
$('form > div:last').addClass('hide');
